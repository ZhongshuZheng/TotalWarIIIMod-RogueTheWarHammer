...
def update_loc_tables(heroes: list[tuple[str, str, str]]) -> None:
    ...
    base_cn = [
        ["dilemmas_localised_title_adamrogue_mvp_hero_reward_dilemma", "商队Rogue：选择英雄奖励", "false"],
        ["dilemmas_localised_description_adamrogue_mvp_hero_reward_dilemma", "本轮你可以从自己派系的 3 名随机英雄中选择 1 名加入 Rogue 部队。选择英雄后将跳过本轮单位奖励，直接进入战斗流程。", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_label_adamrogue_mvp_hero_reward_dilemmaFIRST", "领取英雄候选 I", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaFIRST", "领取下方显示的第一名英雄；如果部队未满员，英雄会加入当前 Rogue 部队并升至当前轮数。", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_label_adamrogue_mvp_hero_reward_dilemmaSECOND", "领取英雄候选 II", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaSECOND", "领取下方显示的第二名英雄；如果部队未满员，英雄会加入当前 Rogue 部队并升至当前轮数。", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_label_adamrogue_mvp_hero_reward_dilemmaTHIRD", "领取英雄候选 III", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaTHIRD", "领取下方显示的第三名英雄；如果部队未满员，英雄会加入当前 Rogue 部队并升至当前轮数。", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_label_adamrogue_mvp_hero_reward_dilemmaFOURTH", "稍后再选", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaFOURTH", "关闭事件，之后可通过 Mod 按钮重新打开同一组英雄候选。", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_label_adamrogue_mvp_hero_reward_dilemmaFIFTH", "切换普通单位奖励", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaFIFTH", "放弃本轮英雄奖励，改为进入正常单位奖励事件；之后仍会进入正常战斗流程。", "false"],
        ["dilemmas_localised_title_adamrogue_mvp_hero_reward_full_dilemma", "商队Rogue：部队已满员", "false"],
        ["dilemmas_localised_description_adamrogue_mvp_hero_reward_full_dilemma", "当前 Rogue 部队已经达到 20 个单位，无法再加入英雄。请先调整部队容量，或返回奖励页面选择其他处理方式。", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_label_adamrogue_mvp_hero_reward_full_dilemmaFIRST", "返回奖励页面", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_full_dilemmaFIRST", "回到上一页英雄奖励候选。", "false"],
    ]
    base_en = [
        ["dilemmas_localised_title_adamrogue_mvp_hero_reward_dilemma", "AdamRogue: Choose Hero Reward", "false"],
        ["dilemmas_localised_description_adamrogue_mvp_hero_reward_dilemma", "This round, choose 1 of 3 random heroes from your own faction to join the Rogue force. Taking a hero skips the normal unit reward and proceeds directly to the battle flow.", "false"],
        ...
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaFIRST", "Claim the first hero shown below. If the army has space, the hero joins this Rogue force and is raised to the current cycle rank.", "false"],
        ...
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaSECOND", "Claim the second hero shown below. If the army has space, the hero joins this Rogue force and is raised to the current cycle rank.", "false"],
        ...
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaTHIRD", "Claim the third hero shown below. If the army has space, the hero joins this Rogue force and is raised to the current cycle rank.", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_label_adamrogue_mvp_hero_reward_dilemmaFOURTH", "Choose Later", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaFOURTH", "Close this event and reopen the same hero candidates later from the Mod button.", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_label_adamrogue_mvp_hero_reward_dilemmaFIFTH", "Switch to Unit Reward", "false"],
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_dilemmaFIFTH", "Skip the hero reward this round and open the normal unit reward event. The usual battle flow continues afterwards.", "false"],
        ["dilemmas_localised_title_adamrogue_mvp_hero_reward_full_dilemma", "AdamRogue: Army Is Full", "false"],
        ["dilemmas_localised_description_adamrogue_mvp_hero_reward_full_dilemma", "The current Rogue force already has 20 units, so a hero cannot join. Free up a slot first, or return to the reward page and choose another option.", "false"],
        ...
        ["cdir_events_dilemma_choice_details_localised_choice_title_adamrogue_mvp_hero_reward_full_dilemmaFIRST", "Return to the previous hero reward candidates.", "false"],
    ]
